...
<html>
   ...
   <body>
      ...
      <div class="banner">
         <div class="container">
            <div class="banner_heading">Article</div>
         </div>
      </div>
         ...
         <c:forEach  var="content" items="${blogData}">
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4 title">
               <div class="blog_content">
                  <div class="card-title mb-2"><a href="/article/${content.titleUrl}">${content.heading}</a></div>
                  <p class="card-text">${fn:escapeXml(fn:substring(content.content.replaceAll('<.*?>' , ""), 0, 300))}</p>
                  <div class="banner-bottom1-grid1-left"><a class="btn btn-primary" href="/article/${content.titleUrl}">Read More..</a></div>

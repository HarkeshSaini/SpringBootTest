...
<html>
   <head>
      ...
      <title>Main Add News Article Content</title>
            ...
            <div class="col-12 col-md-12 col-lg-12 col-xl-6">
               <div class="card-fluid">
                  <div class="card-body p-5 text-center">
                   <form action="/admin/newsArticle" method="post" enctype= "multipart/form-data">
                     <h3 class="mb-5 homes">${article}</h3>
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-md-4 mb-3">
                           <div class="form-outline">
                           	   <input type="text" name="titleUrl" class="form-control form-control-lg" placeholder="Enter Title Url"/>
                              <div class="form-outline"> 
                              </div>
                           </div>
                        </div>
                        <div class="form-group">
                         ...
                         <div class="form-group">
                           ...
                           <div class="col-md-4 mb-3">
                              <div class="form-outline">
                                 <input type="text" name="categoryName" class="form-control form-control-lg" placeholder="Enter CategoryName"/>
                              </div>
                           </div>
                           <div class="col-md-4 mb-3">
                              <div class="form-outline">

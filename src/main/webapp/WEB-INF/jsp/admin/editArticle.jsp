            ...
            <div class="col-12 col-md-12 col-lg-12 col-xl-6">
               <div class="card-fluid">
                  <div class="card-body p-5 text-center">
                   <form:form action="/admin/newsArticle/${id}" method="post" enctype= "multipart/form-data">
                     ...
                     <div class="form-group">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                           <div class="col-md-4 mb-3">
                              <div class="form-outline">
                                 <form:input type="text" path="posttime" class="form-control form-control-lg" placeholder="Enter Posttime"/>
                              </div>
                           </div>
                           <div class="col-md-4 mb-3">
                              <div class="form-outline">
